...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $authors = $em->getRepository('LibraryBundle:Author')->findAll();
    ...
    {
        $author = new Author();
        $form = $this->createForm('LibraryBundle\Form\AuthorType', $author);
    ...
    {
        $deleteForm = $this->createDeleteForm($author);
        $editForm = $this->createForm('LibraryBundle\Form\AuthorType', $author);
